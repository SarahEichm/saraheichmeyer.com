  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedright\arraybackslash\hsize=1.733\hsize}X
       % sum=2.0\hsize for 2 columns
        ...
        & \\
& Supply-Side Determinants of Prescription Opioid Use: Evidence from Primary Care (with Jonathan Zhang). July 2022. \textit{R\&R at Journal of Public Economics.}   \\
& \\
...
& \\
& Experimental Evidence on the Effectiveness of Non-Experts for Improving Vaccine Demand (with Marcella Alsan). February 2022. \textit{Cond. Accepted at American Economic Journal: Economic Policy.} \\
        & \\
