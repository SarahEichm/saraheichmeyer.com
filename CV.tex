  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedright\arraybackslash\hsize=1.733\hsize}X
       % sum=2.0\hsize for 2 columns
        ...
        & \\
& Primary Care Providers’ Influence on Opioid Use and Its Adverse Consequences (with Jonathan Zhang). October 2022. \textit{Accepted at Journal of Public Economics.}   \\
& \\
