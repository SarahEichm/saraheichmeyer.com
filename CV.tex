...
{ %\setlength{\extrarowheight}{.5em}
  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedleft\arraybackslash\hsize=0.45\hsize}X
      ...
      \underline {{Position}}  & Asst. Professor of Economics (non-tenure track), University of Munich (LMU) & since 1/2021 \\ 
      & & \\
...
{ %\setlength{\extrarowheight}{.5em}
  ...
  \begin{tabularx}{\linewidth}{@{}
    >{\raggedright\arraybackslash\hsize=0.266\hsize}X% 10% of 4\hsize 
    >{\raggedright\arraybackslash\hsize=1.733\hsize}X
       % sum=2.0\hsize for 2 columns
  }
        \underline{{Publications}}   & Pathways Into Opioid Addiction: Evidence From Practice Variation in Emergency Departments (with J. Zhang). Forthcoming, \textit{American Economic Journal: Applied Economics}.   \\
        &  \\
...
&  \\
        \underline{{Papers}}  & Parenthood in Poverty \textit{[JMP]} (with Christina Kent). October 2021. \\
        & \\
...
{ %\setlength{\extrarowheight}{.5em}
  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedleft\arraybackslash\hsize=0.45\hsize}X
      ...
      \underline {{Teaching}}  & Economic and Social Problems: Insights From Big Data, graduate level & 2021 \\ 
      & Political Economy and the Media, undergraduate level & 2021\\
& Munich CES Lecture on Political Economy and Online Media, graduate level & 2020 \\
      & & \\
