  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedright\arraybackslash\hsize=1.733\hsize}X
       % sum=2.0\hsize for 2 columns
        ...
        & \\
        & Civil Liberties in Times of Crisis (with Marcella Alsan, Luca Braghieri, Min Jeong Kim, Stefanie Stantcheva and David Yang). July 2022. \textit{R\&R at American Economic Journal: Applied Economics.} \\
& \\
