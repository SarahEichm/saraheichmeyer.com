  ...
  \begin{tabularx}{\linewidth}{@{}
    ...
    >{\raggedright\arraybackslash\hsize=1.733\hsize}X
       % sum=2.0\hsize for 2 columns
          ...
          \underline{Working Papers}  & Parenthood in Poverty \textit{[JMP]} (with Christina Kent). July 2022. \\
        & \\
& Supply-Side Determinants of Prescription Opioid Use: Evidence from Primary Care (with Jonathan Zhang). July 2022.   \\
& \\
